...
namespace HRIS.API
{
    ...
    {
        Task<IEnumerable<ActiveStaffDto>> GetActiveStaffReportAsync(string userID, string rcs, string dps, string locations, string titles, string backupTitles, string csStatus, int pageNumber = 1, int pageSize = 10, string sortColumn = "", string sortOrder = "", string searchTerm = "");
        Task<IEnumerable<StaffEmergencyContactInfoReportDto>> GetStaffEmergencyContactInfoReportAsync(string userID, string rcs, string dps, string locations, int pageNumber = 1, int pageSize = 10, string sortColumn = "", string sortOrder = "", string searchTerm = "");
        Task<IEnumerable<StaffLeaveReportDto>> GetStaffLeaveReportAsync(string userID, string rcs, string dps, string titles, string lvStatus, string option = "", int pageNumber = 1, int pageSize = 10, string sortColumn = "", string sortOrder = "", string searchTerm = "");
        Task<IEnumerable<VacationRosterReportDto>> GetVacationRosterReportAsync(string userID, string rcs, string dps, string locations, string titles, int pageNumber = 1, int pageSize = 10, string sortColumn = "", string sortOrder = "", string searchTerm = "");
        Task<IEnumerable<OvertimeCitytimeReportDto>> GetOvertimeCitytimeReportAsync(string userID, string rcs, string dps, int minDate, int maxDate, bool totalOnly = true);
        Task<IEnumerable<EEOChartDto>> GetGenderBreakdownChartAsync(string userID, string rcs, string dps);
        Task<IEnumerable<EEOChartDto>> GetAgencyDemographicChartAsync(string userID, string rcs, string dps);
    }
    ...
    public class HRISRepository : Repository, IHRISReportRepository
    {
        ...
        public async Task<IEnumerable<ActiveStaffDto>> GetActiveStaffReportAsync(string userID,
        ...
        public async Task<IEnumerable<StaffLeaveReportDto>> GetStaffLeaveReportAsync(string userID, string rcs, string dps
        ...
        public async Task<IEnumerable<StaffEmergencyContactInfoReportDto>> GetStaffEmergencyContactInfoReportAsync(string userID, string rcs, string dps, string locations, int pageNumber = 1, int pageSize = 10, string sortColumn = "", string sortOrder = "", string searchTerm = "")
        {
        ...
        public async Task<IEnumerable<VacationRosterReportDto>> GetVacationRosterReportAsync(string userID, string rcs, string dps, string locations, string titles, int pageNumber = 1, int pageSize = 10, string sortColumn = "", string sortOrder = "", string searchTerm = "")
        {
        ...
        public async Task<IEnumerable<OvertimeCitytimeReportDto>> GetOvertimeCitytimeReportAsync(string userID, string rcs, string dps, int minDate, int maxDate, bool totalOnly = true)
        {
        ...
        public async Task<IEnumerable<EEOChartDto>> GetGenderBreakdownChartAsync(string userID, string rcs, string dps)
        {
            try
            {
        ...
        public async Task<IEnumerable<EEOChartDto>> GetAgencyDemographicChartAsync(string userID, string rcs, string dps)
        {
            try
            {
                List<EEOChartDto> dtos = new List<EEOChartDto>();
                ...
                SqlParameter[] sqlParameters = new SqlParameter[] {
                    new SqlParameter("@userID", userID), new SqlParameter("@RCs", rcs), new SqlParameter("@DPs", dps) };
