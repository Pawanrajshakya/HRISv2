...
import { IECardByRelationshipReport } from 'src/app/_models/IECard';

@Component({
  selector: 'app-ecard-by-relationship',
  templateUrl: './ecard-by-relationship.component.html',
  styleUrls: ['./ecard-by-relationship.component.scss'],
})
export class EcardByRelationshipComponent
  extends BaseComponent<IECardByRelationshipReport>
  implements AfterViewInit, OnInit
{
      ...
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.dataService
            .GetECardByRelationshipReport$(this.reportParam)
  ...
  onExport() {
    this.reportParam.isSentBy ?? true === true
      ? this.download(this.modalService, Reports[20])
      : this.download(this.modalService, Reports[21]);
  }
}
