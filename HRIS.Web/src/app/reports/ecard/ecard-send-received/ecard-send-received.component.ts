...
import { IECardSendAndReceivedReport } from 'src/app/_models/IECard';

@Component({
  selector: 'app-ecard-send-received',
  templateUrl: './ecard-send-received.component.html',
  styleUrls: ['./ecard-send-received.component.scss'],
})
export class EcardSendReceivedComponent
  extends BaseComponent<IECardSendAndReceivedReport>
  implements AfterViewInit, OnInit
{
      ...
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.dataService
            .ECardSendAndReceivedReport$(this.reportParam)
  ...
  onExport() {
    this.reportParam.isSentBy ?? true === true
      ? this.download(this.modalService, Reports[19])
