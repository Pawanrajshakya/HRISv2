...
@Component({
  selector: 'app-headcount-report-reconciliation-summary',
  templateUrl: './headcount-report-reconciliation-summary.component.html',
  styleUrls: ['./headcount-report-reconciliation-summary.component.scss'],
})
export class HeadcountReportReconciliationSummaryComponent
  extends BaseComponent<IHeadcountTitleAndBudgetReconciliationSummaryReport>
  implements AfterViewInit, OnInit
{
      ...
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.headcountService
            .titleAndBudgetReconciliationSummary$(this.reportParam)
  ...
  onExport() {
    this.download(this.modalService, Reports[13]);
  }
}
